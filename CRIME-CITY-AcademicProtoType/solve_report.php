<?php
// solve reports as case files for all users 
?>
...
<head>
    ...
    <title>Case Files | CRIME CITY</title>
...
?>
    ...
    <div class="page">
        <h1><b class="violet">CASE </b><b class="red">FILES</b></h1>
        <div class="table_for_sql_display"></div>
    </div>
